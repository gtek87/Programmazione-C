/* Il programma simula una partita semplificata di Craps, con gestione del saldo del giocatore, puntate, lanci casuali dei dadi e messaggi di intrattenimento. */
